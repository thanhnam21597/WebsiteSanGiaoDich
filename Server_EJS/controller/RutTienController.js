...
module.exports = {
    LayDanhSachRutTien: async function (req, res) {
    ...
    DuyetRutTien: async function (req, res) {
        let id= req.query.id;
        let tongtien = parseInt(req.body.TienNap); // TienNap sai 3900
        console.log("tong tien can rut"+tongtien);
        console.log("idkhach hang rut tien : "+id);
        const client = new MongoClient(DbUrl, { useNewUrlParser: true, useUnifiedTopology: true });
    ...
    LayChiTietRutTienTheoID: async function (req, res) {   
